        ...
        <h1 style={{ textAlign: 'center' ,marginBottom : 100, color: "white"}}>Vozona Gasy</h1>
          <Form onSubmit={(e) => e.preventDefault()} className="d-flex gap-2">
            <div className="position-relative flex-grow-1">
              <Form.Control as="textarea" placeholder="Entrez un texte à traduire" value={inputText} onChange={(e) => { setInputText(e.target.value); e.target.style.height = "auto";  e.target.style.height = `${e.target.scrollHeight}px`; }} className="formControl" />
